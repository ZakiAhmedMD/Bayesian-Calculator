...
_50 tests — all currently `verified: false`. For each: open the source, confirm the quoted sensitivity/specificity match, check the context fits your teaching use, then set `verified: true` in `src/data/diagnoses.json` (optionally add your initials + date to `notes`)._
...
- Source: Booth RA, et al. Performance of BNP and NT-proBNP for diagnosis of heart failure in primary care patients: a systematic review. Heart Fail Rev. 2014;19(4):439-451.  [PubMed 24969534](https://pubmed.ncbi.nlm.nih.gov/24969534/) · [doi](https://doi.org/10.1007/s10741-014-9445-8)
- Quote: “Pooled sensitivity and specificity of BNP and NT-proBNP using the lowest [0.85 (sensitivity) and 0.54 (specificity)], optimal (0.80 and 0.61), and manufacturers' (0.74 and 0.67) cutpoints showed good performance for diagnosing HF.”
- Context: Primary-care populations; performance is cutpoint-dependent (values shown are the 'optimal' cutpoint). Specificity is lower and more variable than sensitivity.
- Note: Best used as a rule-out (high sensitivity at low thresholds). Acute-care thresholds differ; verify before teaching use.
- [ ] Verified by __________  on __________

### 7. NT-proBNP  `(hf-ntprobnp)`
- **Sensitivity 86% · Specificity 58%**
- Source: Booth RA, et al. Performance of BNP and NT-proBNP for diagnosis of heart failure in primary care patients: a systematic review. Heart Fail Rev. 2014;19(4):439-451.  [PubMed 24969534](https://pubmed.ncbi.nlm.nih.gov/24969534/) · [doi](https://doi.org/10.1007/s10741-014-9445-8)
- Quote: “Similar performance was seen for NT-proBNP: lowest (0.90 and 0.50), optimal (0.86 and 0.58), and manufacturers' (0.82 and 0.58) cutpoints.”
- Context: Primary-care populations; 'optimal' cutpoint shown. No statistically significant difference in accuracy vs BNP.
- Note: Rule-out test; threshold- and population-dependent. Verify before teaching use.
- [ ] Verified by __________  on __________
